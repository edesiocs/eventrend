...
public class GUITaskQueue {
	...
	/**
	 * Adds a task with an associated progress indicator. The indicator's showProgressIndicator() 
	 * get called immediately then the hideProgressIndicator() gets called before the GUITask's
