...
public class AST {
	...
	public static class TimeSeriesOperand implements Operand<String> {
		...
		public TimeSeriesOperand(String seriesId) { mCategoryName = seriesId; }
		public void setValue(String seriesId) { mCategoryName = seriesId; }
		public String getValue() { return mCategoryName; }
		public String toString() { return Tokenizer.SERIES + " " 
			+ Tokenizer.SERIES_DELIM + Tokenizer.escape(mCategoryName)
			+ Tokenizer.SERIES_DELIM; }
	}

	public static class FloatOperand implements Operand<Float> {
		private Float mValue = null;
		public FloatOperand() { }
		public FloatOperand(Float value) { mValue = value; }
	...
	public static class LongOperand implements Operand<Long> {
		...
		public LongOperand() { }
		public LongOperand(Long value) { mValue = value; }
	...
	public static class UnitsOperand implements Operand<DateUtil.Period> {
		...
		public UnitsOperand() { }
		public UnitsOperand(DateUtil.Period period) { mPeriod = period; }
		public void setValue(DateUtil.Period period) { mPeriod = period; }
		public DateUtil.Period getValue() { return mPeriod; }
		public String toString() { return DateUtil.mapPeriodToString(mPeriod); }
	}

	public static class DeltaOperand implements Operand<String> {
		private String mAxis = null;
		public DeltaOperand() { }
		public DeltaOperand(String axis) { mAxis = axis; }
		public void setValue(String axis) { mAxis = axis; }
		public String getValue() { return mAxis; }
		public String toString() { return mAxis; }
	}

	public static class GroupOperand implements Operand<Operation> {
		private Operation mOp = null;
		public GroupOperand() { }
		public GroupOperand(Operation op) { mOp = op; }
		public void setValue(Operation op) { mOp = op; }
		public Operation getValue() { return mOp; }
		public String toString() { return Tokenizer.GROUP_START + mOp.toString() + 
			Tokenizer.GROUP_END; }
	}
	...
	public static class UnaryOperation<U> implements Operation {
		...
		public UnaryOperation(U operand) { mOperand = operand; }
		
		public Opcode getOpcode() { return mOpcode; }
		public U getOperand() { return mOperand; }
		
		public void setOpcode(Opcode opcode) { mOpcode = opcode; }
		public void setOperand(U operand) { mOperand = operand; }
	...
	public static class BinaryOperation<L,R> implements Operation {
		...
		public Opcode getOpcode() { return mOpcode; }
		public L getOperandLeft() { return mOperandLeft; }
		public R getOperandRight() { return mOperandRight; }
		
		public void setOpcode(Opcode opcode) { mOpcode = opcode; }
		public void setOperandLeft(L operand) { mOperandLeft = operand; }
		public void setOperandRight(R operand) { mOperandRight = operand; }
	...
	private Operand getOperand(Tokenizer.Token out) {
		...
		else if (out.mTokenID == Tokenizer.TokenID.DELTA_TIMESTAMP || out.mTokenID == Tokenizer.TokenID.DELTA_VALUE) {
	...
	private Tokenizer.Token getOperator(TokenID bindingType) {
		...
		if (bindingType == Tokenizer.TokenID.SERIES) {
			...
			if (op.mTokenID != Tokenizer.TokenID.PLUS && op.mTokenID != Tokenizer.TokenID.MINUS
					&& op.mTokenID != Tokenizer.TokenID.MULTIPLY && op.mTokenID != Tokenizer.TokenID.DIVIDE
			...
			if (op.mTokenID != Tokenizer.TokenID.DELTA_TIMESTAMP && op.mTokenID != Tokenizer.TokenID.DELTA_VALUE) {
				op.mTokenID = Tokenizer.TokenID.UNKNOWN;
			}			
		}
		else if (op.mTokenID != Tokenizer.TokenID.PLUS && op.mTokenID != Tokenizer.TokenID.MINUS
				&& op.mTokenID != Tokenizer.TokenID.MULTIPLY && op.mTokenID != Tokenizer.TokenID.DIVIDE) {
			op.mTokenID = Tokenizer.TokenID.UNKNOWN;
		}
		return op;
