...
//    }
    ...
    public static final String[] KEY_PERIODS = {
    	KEY_PERIOD_NONE, 
    	KEY_PERIOD_HOUR,
    	KEY_PERIOD_AMPM, 
    	KEY_PERIOD_DAY,
    ...
    public static final long[] KEY_PERIODS_MS = {
    	0, 
    	DateUtil.HOUR_MS,
    	DateUtil.AMPM_MS, 
    	DateUtil.DAY_MS,
    ...
    public static final String TABLE_CREATE =
            "create table " + TABLE_NAME + " ("
                    ...
                    + KEY_DEFAULT_VALUE + " float not null, "
                    + KEY_LAST_VALUE + " float not null, "
                    + KEY_LAST_TREND + " float not null, "
                    + KEY_INCREMENT + " float not null, "
                    + KEY_GOAL + " float not null, "
                    + KEY_COLOR + " text not null, "
                    + KEY_TYPE + " text not null, "
                    + KEY_PERIOD_MS + " int not null, "
                    + KEY_RANK + " integer not null, "
                    + KEY_PERIOD_ENTRIES + " int not null, "
                    + KEY_TREND_STATE + " text not null, "
                    + KEY_INTERPOLATION + " text not null, "
                    + KEY_ZEROFILL + " byte not null, "
    				+ KEY_SYNTHETIC + " byte not null, "
    ...
    public static long getId(Cursor c) { return c.getLong(c.getColumnIndexOrThrow(KEY_ROWID)); }
    public static String getGroupName(Cursor c) { return c.getString(c.getColumnIndexOrThrow(KEY_GROUP_NAME)); }
    public static String getCategoryName(Cursor c) { return c.getString(c.getColumnIndexOrThrow(KEY_CATEGORY_NAME)); }
    public static float getDefaultValue(Cursor c) { return c.getFloat(c.getColumnIndexOrThrow(KEY_DEFAULT_VALUE)); }
    public static float getLastValue(Cursor c) { return c.getFloat(c.getColumnIndexOrThrow(KEY_LAST_VALUE)); }
    public static float getLastTrend(Cursor c) { return c.getFloat(c.getColumnIndexOrThrow(KEY_LAST_TREND)); }
    public static float getIncrement(Cursor c) { return c.getFloat(c.getColumnIndexOrThrow(KEY_INCREMENT)); }
    public static float getGoal(Cursor c) { return c.getFloat(c.getColumnIndexOrThrow(KEY_GOAL)); }
    public static String getType(Cursor c) { return c.getString(c.getColumnIndexOrThrow(KEY_TYPE)); }
    public static String getColor(Cursor c) { return c.getString(c.getColumnIndexOrThrow(KEY_COLOR)); }
    ...
    public static long getPeriodMs(Cursor c) { return c.getLong(c.getColumnIndexOrThrow(KEY_PERIOD_MS)); }
    public static int getRank(Cursor c) { return c.getInt(c.getColumnIndexOrThrow(KEY_RANK)); }
    public static int getPeriodEntries(Cursor c) { return c.getInt(c.getColumnIndexOrThrow(KEY_PERIOD_ENTRIES)); }
    public static String getTrendState(Cursor c) { return c.getString(c.getColumnIndexOrThrow(KEY_TREND_STATE)); }
    public static String getInterpolation(Cursor c) { return c.getString(c.getColumnIndexOrThrow(KEY_INTERPOLATION)); }
    public static boolean getZeroFill(Cursor c) { return c.getInt(c.getColumnIndexOrThrow(KEY_ZEROFILL)) == 0 ? false : true; }
    public static boolean getSynthetic(Cursor c) { return c.getInt(c.getColumnIndexOrThrow(KEY_SYNTHETIC)) == 0 ? false : true; }
    public static String getFormula(Cursor c) { return c.getString(c.getColumnIndexOrThrow(KEY_FORMULA)); }
