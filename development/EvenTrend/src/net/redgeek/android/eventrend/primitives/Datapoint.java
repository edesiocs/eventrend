...
public final class Datapoint implements Comparator<Datapoint> {
	...
	public Datapoint(long timestamp, float value, long catId, long entryId, int mEntries) {			
	...
	public String toLabelString() {
		...
		return String.format("%d/%02d/%02d %d:%02d", year, month, day, hour, minute);
	}
	...
	public boolean equals(Object obj) {
		...
		if (mMillis == other.mMillis
				&& mCatId == other.mCatId
				&& mEntryId == other.mEntryId
				&& mValue.equals(other.mValue)
				&& mTrend.equals(other.mTrend)
				&& mSynthetic == other.mSynthetic) {
			return true;
		}
		return false;
	}
