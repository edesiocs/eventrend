...
public class Tokenizer {
  ...
  public enum TokenID {
    GROUP_START, GROUP_END, PLUS, MINUS, MULTIPLY, DIVIDE, DELTA, 
    DELTA_TIMESTAMP, DELTA_VALUE, SERIES, LONG_VALUE, FLOAT_VALUE, STRING_VALUE,
    PERIOD_CONSTANT, COMPOSITE, UNKNOWN, EOF
  }
  ...
  public static final String[] PERIODS = { "hour", "ampm", "day", "week",
      "month", "quarter", "year", };
