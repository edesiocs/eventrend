...
import net.redgeek.android.eventrend.input.primitives.EntryDbTable;
...
import net.redgeek.android.eventrend.input.util.Number;
import net.redgeek.android.eventrend.input.util.DateUtil.Period;
