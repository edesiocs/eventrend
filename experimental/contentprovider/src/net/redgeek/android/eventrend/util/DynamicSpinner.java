...
/**
 * Dynamic spinner convenience class, allows for easy adding of items and
 * clearing of a Spinner view.
 * 
 * @author barclay
 * 
 */
public class DynamicSpinner extends Spinner {
   ...
   * constructor set as a Spinner.</strong>
   * 
   * @param context
   *          The Context responsible for this view.
   * @param attrs
   ...
   * allocates and ArrayAdapter for the Spinner, sets it's resources, and sets
   ...
   * @param mapping
   *          A number associated with the entry, can be arbitrary.
