...
public class EntryDbTable {
    ...
    public static final String TABLE_CREATE =
            "create table " + TABLE_NAME + " ("
                    ...
                    + KEY_CATEGORY_ID + " integer key not null, "
                    + KEY_TIMESTAMP + " long key not null, "
                    + KEY_VALUE + " float not null, "
                    + KEY_N_ENTRIES + " integer not null);";
    
    public static long getId(Cursor c) { return c.getLong(c.getColumnIndexOrThrow(KEY_ROWID)); }
    public static long getCategoryId(Cursor c) { return c.getLong(c.getColumnIndexOrThrow(KEY_CATEGORY_ID)); }
    public static long getTimestamp(Cursor c) { return c.getLong(c.getColumnIndexOrThrow(KEY_TIMESTAMP)); }
    public static float getValue(Cursor c) { return c.getFloat(c.getColumnIndexOrThrow(KEY_VALUE)); }
    public static int getNEntries(Cursor c) { return c.getInt(c.getColumnIndexOrThrow(KEY_N_ENTRIES)); }
