...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        ColorPickerView(Context c, OnColorChangedListener l, int color) {
            ...
            Shader s = new LinearGradient(0, -CENTER_Y + 5, 0, CENTER_Y - 5, mSaturations, null, Shader.TileMode.CLAMP);
            ...
            Shader v = new LinearGradient(-CENTER_X + 5, 0, CENTER_X - 5, 0, mValues, null, Shader.TileMode.CLAMP);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(new RectF(r + mPaint.getStrokeWidth() + DIVIDER_PAD, 
            						 -r, 
            						  r + mPaint.getStrokeWidth() + DIVIDER_PAD + SATURATION_STRIPE, 
            						  r), mSaturationPaint);
            canvas.drawRect(new RectF(-r, 
					 				   r + mPaint.getStrokeWidth() + DIVIDER_PAD, 
					 				   r, 
					 				   r + mPaint.getStrokeWidth() + DIVIDER_PAD + SATURATION_STRIPE), mValuePaint);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            setMeasuredDimension(CENTER_X*2 + EXTRA_RIGHT, CENTER_Y*2 + EXTRA_BOTTOM);
        }
                ...
                case MotionEvent.ACTION_MOVE:
                    if (mTrackingCenter) {
                    	...
                    	if (x < CENTER_X && y < CENTER_Y) {
                            ...
                            mCenterPaint.setColor(shadeColorSaturation(mColors, mCenterPaint, unit));
                    		invalidate();
                    	}
                    	else if (y > CENTER_Y){
                    		float unit = 1 - ((x + CENTER_X) / (CENTER_X * 2));
                    		unit = Number.Clamp(unit, 0.0f, 1.0f);
                            mCenterPaint.setColor(shadeColorValue(mColors, mCenterPaint, unit));
                    		invalidate();
                    	}
                    }
                    break;
