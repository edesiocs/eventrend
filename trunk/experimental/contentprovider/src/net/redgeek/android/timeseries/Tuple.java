...
public class Tuple implements Comparable<Tuple> {
  ...
  /**
   * Set a Tuple to the values of x and y creating a new Tuple. Essentially the
   * assignment operator.
   * 
   * @param x
  ...
  /**
   * Adds <code>other</code> to <code>this</code>, modifying <code>this</code>
   * and returning it.
   * 
   * @param other
   *          The Tuple to add.
  ...
  /**
   * Subtracts <code>other</code> from both <code>this.x</code> and
   * <code>this.y</code>, modifying <code>this</code> and returning it.
   * 
   * @param other
  ...
  /**
   * Subtracts Tuple <code>b</code> from <code>a</code>, generating a new Tuple
   * and returning it. Does not modify <code>a</code> or <code>b</code>.
   * 
   * @param a
   *          A Tuple
   * @param b
  ...
  /**
   * Multiplies <code>this</code> by <code>other</code>, modifying
   * <code>this</code> and returning it.
   * 
   * @param other
  ...
  /**
   * Multiplies both <code>this.x</code> and <code>this.y</code> by
   * <code>other</code>, modifying <code>this</code> and returning it.
   * 
   * @param other
  ...
  /**
   * Multiplies Tuples <code>a</code> and <code>b</code>, generating a new Tuple
   * and returning it. Does not modify <code>a</code> or <code>b</code>.
   * 
   * @param a
   *          A Tuple
  ...
  /**
   * Divides <code>this</code> by <code>other</code>, modifying
   * <code>this</code> and returning it. Does not check for division by zero.
   * 
   * @param other
  ...
  /**
   * Divides both <code>this.x</code> and <code>this.y</code> by
   * <code>other</code>, modifying <code>this</code> and returning it. Does not
   ...
   * returning it. Does not modify <code>a</code> or <code>b</code>. Does not
   * check for division by zero.
   * 
   * @param a
   *          A Tuple
   ...
   * <code>other.x</code>. Does the same for <code>other.y</code>. Returns this.
   * 
   * @param other
  ...
  /**
   * Compares both <code>x</code> and <code>y</code> components of
   * <code>a</code> and <code>b</code>, and returns a new Tuple with the minimum
  ...
  /**
   * Compares both <code>x</code> and <code>y</code> components of
   * <code>a</code> and <code>b</code>, and returns a new Tuple with the maximum
   * values of the respective components.
   * 
   * @param a
   *          A Tuple.
