...
public class DialogUtil {
	 ...
	 * context passed in.
	 * 
	 * @param ctx The context to associate with the factory.
	 */
	 ...
	 * @param v The View to add to the dialog.
	 * @return The Dialog.
	 */
	public Dialog newViewDialog(String message, View v) {
		mBuilder.setMessage(message);
		Dialog d = mBuilder.create();
		d.addContentView(v, new LinearLayout.LayoutParams(
	...
	/** Creates a new Dialog with the specified title and message with a single "Ok"
	 * button that does nothing. Equivalent to calling 
	 * {@link #newOkDialog(String, String, DialogInterface.OnClickListener)}
	 * with a listener of {@link #getDoNothingListener()}
	 * @param title The title of the dialog.
	 * @param message The message to display in the dialog.
	 * @return The Dialog.
	...
	public Dialog newOkDialog(String title, String message) {
		return newOkDialog(title, message, (DialogInterface.OnClickListener) mDoNothing);
    }    

	/** Creates a new Dialog with the specified title, message, and onClickListener,
	...
	/** Creates a new Dialog with the specified title and message with a single "Ok"
	 * associate with <code>ok</code>, and a cancel button that does nothing.
	 ...
	 * @param title The title of the dialog.
	 * @param message The message to display in the dialog.
	 * @param ok The listener for the "Ok" button.
	 * @return The Dialog.
	 * @see #newOkCancelDialog(String, String, DialogInterface.OnClickListener, DialogInterface.OnClickListener)
	 * @see #getDoNothingListener()
	 */
	public Dialog newOkCancelDialog(String title, String message, DialogInterface.OnClickListener ok) {
		return newOkCancelDialog(title, message, ok, (DialogInterface.OnClickListener) mDoNothing);
    }    

	/** Creates a new Dialog with the specified title, message, and onClickListeners,
	 * associated with the "Ok" button and "Cancel" buttons respectively.
	 * @param title The title of the dialog.
	 * @param message The message to display in the dialog.
	 * @return The Dialog.
	 */
	...
	/** Creates a new ProgressDialog will the message specified.  The dialog is cancel-able
	...
	/** Creates a new ProgressDialog will the message and title specified.  The dialog is 
	 * cancel-able and progress is indeterminate.
	 * @param message The title of the dialog.
	 * @param title The message to display in the dialog.
	 * @return The ProgressDialog.
	 */
    ...
    /** Retrieve a reference to a listener that does nothing.  Multiple calls will result
     * in the same reference, and new instance is not created.
