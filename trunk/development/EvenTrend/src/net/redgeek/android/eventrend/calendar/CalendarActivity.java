...
public class CalendarActivity extends EvenTrendActivity {
    ...
    private void setupUI() {
        ...
        mCalendarControls.addView(mPeriodSpinner, new LinearLayout.LayoutParams(
                LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
//        mPeriodSpinner.addSpinnerItem(CategoryDbTable.KEY_PERIOD_DAY, new Long(0));
...
//        mPeriodSpinner.addSpinnerItem(CategoryDbTable.KEY_PERIOD_YEAR, new Long(2));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	menu.add(0, MENU_CALENDAR_RANGE_ID, 0, R.string.menu_calendar_range).setIcon(android.R.drawable.ic_dialog_info);
        menu.add(0, MENU_CALENDAR_GRAPH_ID, 0, R.string.menu_graph).setIcon(R.drawable.graph);
        menu.add(0, MENU_CALENDAR_PREFS_ID, 0, R.string.menu_app_prefs).setIcon(android.R.drawable.ic_menu_preferences);
