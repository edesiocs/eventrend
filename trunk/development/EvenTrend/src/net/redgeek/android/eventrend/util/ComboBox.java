...
/** Implements a "ComboBox", that is, an EditText box coupled with an "pop-up" menu
 * of values that will populate the EditText if selected.
 * 
 * @author barclay
 */
public class ComboBox extends LinearLayout {
	...
	/**  Constructor.  Creates an empty ComboBox associated with
	 ...
	 * the same constructor set as an EditText.</strong>
	 * 
	 * @param context The Context responsible for this view.
	 * @param attrs (Ignored.)
	 */
	 ...
	 * various member variables, sets up the UI elements of the view, creates the popup
	 * menu (Dialog), and establishes a listener for the menu.
	 * 
	...
	private void setup(Context context) {
        ...
        addView(mLayout, new LinearLayout.LayoutParams(
     ...
     * 
     * @param text The text to set in the EditText view.
     */
	public void setDefaultValue(String text) { setText(text); }	

	/** Adds an item to the popup menu
	 * 
	 * @param text The text to add
	 */
	public void addMenuItem(String text) { mAdapter.add(text); }
	
	/** Clears all menu items from the popup menu.
	 */
	public void clearMenuItems() { mAdapter.clear(); }

	/** Calls extendSelection(int index) on the EditText portion of the ComboBox
	 * @see EditText#extendSelection(int)
	 */
 	public void extendSelection(int index) { mEditText.extendSelection(index); }
 	
	/** Calls getText() on the EditText portion of the ComboBox
	 * @see EditText#getText()
	 */
 	public Editable getText() { return mEditText.getText(); }

 	/** Calls selectAll() on the EditText portion of the ComboBox
	 * @see EditText#selectAll()
	 */
 	public void selectAll() { mEditText.selectAll(); }

 	/** Calls setSelection(int start, int stop) on the EditText portion of the ComboBox
	 * @see EditText#setSelection(int, int)
	 */
 	public void setSelection(int start, int stop) { mEditText.setSelection(start, stop); }

 	/** Calls setSelection(int index) on the EditText portion of the ComboBox
	 * @see EditText#setSelection(int)
	 */
 	public void setSelection(int index) { mEditText.setSelection(index); }

 	/** Calls setText(CharSequence text, TextView.BufferType type) on the EditText portion of the ComboBox
